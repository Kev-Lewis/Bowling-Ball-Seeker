...
import { scrapeDV8ManufacturerCatalog } from "../scrapers/manufacturers/dv8Scraper";
...
export async function runEboniteManufacturerSync(options: {
  sourceUrl: string;
  brandName: string;
  maxPages?: number | null;
  scrapeDelayMs?: number | null;
  ...
  try {
    const catalogResult = await scrapeEboniteManufacturerCatalog({
      sourceUrl: options.sourceUrl,
      brandName: options.brandName,
      maxPages: options.maxPages,
      scrapeDelayMs: options.scrapeDelayMs,
...
export async function runRadicalManufacturerSync(options: {
  sourceUrl: string;
  brandName: string;
  maxPages?: number | null;
  scrapeDelayMs?: number | null;
  ...
  try {
    const catalogResult = await scrapeRadicalManufacturerCatalog({
      sourceUrl: options.sourceUrl,
      brandName: options.brandName,
      maxPages: options.maxPages,
      scrapeDelayMs: options.scrapeDelayMs,
...
export async function runDV8ManufacturerSync(options: {
  sourceUrl: string;
  brandName: string;
  maxPages?: number | null;
  scrapeDelayMs?: number | null;
  ...
  try {
    const catalogResult = await scrapeDV8ManufacturerCatalog({
      sourceUrl: options.sourceUrl,
      brandName: options.brandName,
      maxPages: options.maxPages,
      scrapeDelayMs: options.scrapeDelayMs,
...
export async function runTrackedManufacturerSourceSync(source: {
  ...
  if (source.parserKey === "radical") {
    return runRadicalManufacturerSync({
      sourceUrl: source.url,
      brandName: source.brandName ?? source.manufacturerName,
      maxPages: source.maxPages,
      scrapeDelayMs: source.scrapeDelayMs,
  ...
  if (source.parserKey === "dv8") {
    return runDV8ManufacturerSync({
      sourceUrl: source.url,
      brandName: source.brandName ?? source.manufacturerName,
      maxPages: source.maxPages,
      scrapeDelayMs: source.scrapeDelayMs,
